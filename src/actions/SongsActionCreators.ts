...
import { GET_POPULAR_SONGS, GET_RELATED_SONGS, GET_SONGS_BY_SEARCH, GET_ERRORS, GET_PLAYING_SONGS } from '../types/action.types';
import { AppActions } from '.';
import { RelatedSongsObject } from '../types/related.data';
import { SearchSongsObject, Item } from '../types/search.data';
import { AxiosResponse } from 'axios';

export const getPopularSongsActionCreator = (data: PopularSongsObject): AppActions => {
    return {
...
export const getRelatedSongsActionCreator = (data: RelatedSongsObject): AppActions => {
    return {
...
export const getSongsBySearchActionCreator = (data: SearchSongsObject): AppActions => {
    return {
